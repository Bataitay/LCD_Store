        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('assets/images/logo-sm.png ')); ?>" alt="logo-sm" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('assets/images/logo-dark.png ')); ?>" alt="logo-dark" height="20">
                    </span>
                </a>

                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('assets/images/logolcd.png ')); ?>" alt="logo-sm-light" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('assets/images/logolcd.png ')); ?>" alt="logo-light" height="40">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <img class="" src="<?php echo e(asset('assets/images/flags/us.jpg')); ?>" alt="Header Language"
                        height="16">
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/spain.jpg')); ?>" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/germany.jpg')); ?>" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/italy.jpg')); ?>" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/russia.jpg')); ?>" alt="user-image" class="me-1"
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?php echo e(!empty(auth()->user()->avatar) ? asset(auth()->user()->avatar) : asset('assets/images/no_image.png')); ?>"
                         alt="Header Avatar">
...
<?php /**PATH C:\laragon\www\LCD-Store\resources\views/back-end/layouts/header.blade.php ENDPATH**/ ?>