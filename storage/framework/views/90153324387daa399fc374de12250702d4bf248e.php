            ...
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden"
                        src="<?php echo e(asset('assets/images/login-office.jpeg')); ?>" alt="Office" />
                    <img aria-hidden="true" class="hidden object-cover w-full h-full dark:block"
                        src="<?php echo e(asset('assets/images/login-office-dark.jpeg')); ?>" alt="Office" />
                </div>
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200">Login</h1>
                        <form action="<?php echo e(route('user.handelLogin')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\LCD-Store\resources\views/back-end/auth/login.blade.php ENDPATH**/ ?>