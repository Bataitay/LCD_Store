        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="<?php echo e(asset('assets/img/create-account-office.jpeg')); ?>"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="<?php echo e(asset('assets/img/create-account-office-dark.jpeg')); ?>"
              alt="Office"
            />
          </div>
...
<?php /**PATH C:\laragon\www\LCD-Store\resources\views/back-end/auth/register.blade.php ENDPATH**/ ?>